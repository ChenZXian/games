...
public class MinecartAudio {
    ...
    public MinecartAudio(Context context) {
        ...
        loadSound("lane", "audio/sfx_lane.wav");
        loadSound("hazard", "audio/sfx_hazard.wav");
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (!enabled) {
            ...
            playBgm(currentBgm, currentBgm.contains("menu") ? 0.42f : 0.48f);
        }
    }
