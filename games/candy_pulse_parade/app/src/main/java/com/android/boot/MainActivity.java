...
import com.android.boot.ui.CandyBoardView;

import java.util.List;

public class MainActivity extends AppCompatActivity implements CandyBoardView.Listener {
    private AudioController audioController;
    private CandyBoardView boardView;
    ...
    private List<CandyStage> campaign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        campaign = CandyStage.createCampaign();
    ...
    private void bindButtons() {
        ...
        findViewById(R.id.btn_menu_link).setOnClickListener(v -> showMenu());
        ...
        findViewById(R.id.btn_booster).setOnClickListener(v -> boardView.triggerBooster());
        findViewById(R.id.btn_hint).setOnClickListener(v -> boardView.showHint());
    ...
    private void startStage(int stageIndex) {
        hideAllOverlays();
        CandyStage stage = campaign.get(stageIndex);
    ...
    private void updateStageHeader(CandyStage stage) {
        chapterLabel.setText(String.valueOf(stage.chapterIndex));
        stageLabel.setText(stage.getCode());
    ...
    @Override
    public void onHudUpdated(CandyStage stage, int score, int movesLeft, int combo, String objectiveLabel) {
        chapterLabel.setText(String.valueOf(stage.chapterIndex));
        stageLabel.setText(stage.getCode());
    ...
    public void onStageResolved(boolean cleared, String message) {
        ...
        resultTitle.setText(cleared ? "Stage Clear" : "Out Of Moves");
