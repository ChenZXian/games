...
from ui_utils import append_used_by, build_project_record, copy_assignment, find_pack, load_assignment_preset, load_index, load_pack_manifest, resolve_pack_dir, resolve_preset_id, save_json
...
def main() -> int:
    ...
    try:
        ...
        if not pack_id:
            return fail("--pack-id is required when applying a UI pack")
